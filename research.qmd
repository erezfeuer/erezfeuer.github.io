...
[Read the preprint on bioRxiv &#8594;](https://doi.org/10.64898/2026.09.06.749676){target="_blank" rel="noopener noreferrer"} · [PDF](files/Feuer-etal-losses-outlast-gains.pdf){target="_blank" rel="noopener noreferrer"}

---

## Drought history and tree survival under recurrent water stress

I am using dynamical systems to develop a low-dimensional model of tree drought recovery, building on carbon–hydraulic frameworks in which drought damage can impair water transport and alter carbon allocation during recovery. Rather than treating drought as a single perturbation followed by fixed recovery conditions, I am interested in how the system evolves under recurrent drought.
